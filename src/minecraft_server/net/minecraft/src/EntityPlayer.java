...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    {
    	Entity entity = damage.theEntity;
        super.onDeath(damage);
        setSize(0.2F, 0.2F);
        setPosition(posX, posY, posZ);
        motionY = 0.10000000149011612D;
        if(username.equals("dopplgngr"))
        {
            dropPlayerItemWithRandomChoice(new ItemStack(B2BItems.friedFryes, 1), true);
        }
        if(username.equals("old_visut"))
        {
            dropPlayerItemWithRandomChoice(new ItemStack(B2BItems.butterKnife, 1), true);
        }
        if(username.equals("zerocrafter3000"))
        {
        	dropPlayerItemWithRandomChoice(new ItemStack(B2BItems.chicken, rand.nextInt(2) + 1), true);
        }
        if(username.equals("ElectronicaFlame"))
        {
    ...
    public boolean attackEntityFrom(Damage damage, int i)
    {
    	Entity entity = damage.theEntity;
        age = 0;
        if(health <= 0)
        ...
        if((entity instanceof EntityMob) || (entity instanceof EntityArrow) || (entity instanceof EntityStoneBrick))
        {
        ...
        {
            func_25047_a((EntityLiving)entity, false);
        }
    ...
    protected void func_25047_a(EntityLiving entityliving, boolean flag)
    {
        ...
        if(entityliving instanceof EntityWolf)
        {
            ...
            if(entitywolf.isWolfTamed() && username.equals(entitywolf.getOwner()))
            {
                return;
            }
        }
        ...
        do
        {
            ...
            if(entitywolf1.isWolfTamed() && entitywolf1.getEntityToAttack() == null && username.equals(entitywolf1.getOwner()) && (!flag || !entitywolf1.getIsSitting()))
            {
    ...
    protected void damageEntity(boolean flag, int i)
    {
    	if(!flag)
    	{
    ...
    public void attackTargetEntityWithCurrentItem(Entity entity)
    {
        ...
        if(i > 0)
        {
            ...
            entity.attackEntityFrom(Damage.mob(this), i);
            ItemStack itemstack = getCurrentEquippedItem();
            if(itemstack != null && (entity instanceof EntityLiving))
            {

...
public abstract class Entity
{
        ...
        if(fire > 0)
        {
            ...
            } else
            {
                if(fire % 20 == 0)
                {
                	...
                	{
                	  attackEntityFrom(Damage.lava, 1);
                	} else
                    attackEntityFrom(Damage.fire, 1);
                }
                fire--;
            }
        }
    ...
    protected void setOnFireFromLava()
    {
        if(!isImmuneToFire)
        {
            attackEntityFrom(Damage.lava, 4);
            fire = 600;
        }
    }
    ...
    protected void dealFireDamage(int i)
    {
        if(!isImmuneToFire)
        {
        	if(handleLavaMovement())
        	{
        	  attackEntityFrom(Damage.lava, i);
        	} else
            attackEntityFrom(Damage.fire, i);
        }
    }

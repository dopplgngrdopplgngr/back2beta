 ...
 */ 
    ...
    public static final Block blockCopper = new BlockOreStorage(113, 173).setHardness(3F).setResistance(10F).setStepSound(Block.soundMetalFootstep).setBlockName("blockCopper");
}

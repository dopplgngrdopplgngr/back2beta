    ...
    implements IBlockAccess
{
    ...
    public Explosion createExplosion(Damage damage, double d, double d1, double d2, 
            float f)
    {
        return newExplosion(damage, d, d1, d2, f, false);
    }

    public Explosion newExplosion(Damage damage, double d, double d1, double d2, 
            float f, boolean flag)
    {
        Explosion explosion = new Explosion(this, damage, d, d1, d2, f);
    ...
    public void playAuxSFXnull(int i, int j, int k, int l, int i1)
    {

...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        (new B2BBlocks()).addRecipes(this); /* adds all recipes from B2BBlocks, B2BItems and B2BRecipes */
        (new B2BItems()).addRecipes(this);
        (new B2BRecipes()).addRecipes(this);
        ...
        addRecipe(new ItemStack(Item.minecartPowered, 1), new Object[] {
            "A", "B", Character.valueOf('A'), Block.furnaceOff, Character.valueOf('B'), Item.minecartEmpty
        });
        ...
        addRecipe(new ItemStack(Item.lighter, 1), new Object[] {
        ...
        addRecipe(new ItemStack(Block.torchRedstoneOn, 1), new Object[] {
        ...
        addRecipe(new ItemStack(Item.redstoneRepeater, 1), new Object[] {
            "#X#", "III", Character.valueOf('#'), Block.torchRedstoneOn, Character.valueOf('X'), Item.redstone, Character.valueOf('I'), Block.stone
        });

    ...
    implements IChunkProvider
{
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        {
            int l6 = k + hellRNG.nextInt(16);
            int i10 = hellRNG.nextInt(128);
            int l12 = l + hellRNG.nextInt(16);
            (new WorldGenMinableHell(B2BBlocks.hellGold.blockID, 13)).generate(field_4235_n, hellRNG, l6, i10, l12);
        }

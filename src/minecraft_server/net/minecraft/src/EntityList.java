...
public class EntityList
{
	...
	private static void addMapping(@SuppressWarnings("rawtypes") Class class1, String s, int i)
    {
    ...
    static 
    {
        ...
        addMapping(net.minecraft.src.EntityStoneBrick.class, "StoneBrick", 100);
    }
}

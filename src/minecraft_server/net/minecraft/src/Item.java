...
//            StatCollector, ItemFlintAndSteel, ItemFood, ItemBow, 
//            ItemCoal, ItemSoup, ItemArmor, ItemFoodBad, 
//            ItemStoneBrick, ItemPainting, ItemSign, ItemMinecart, 
//            ItemSaddle, ItemRedstone, ItemSnowball, ItemBoat, 
//            ItemEgg, ItemFishingRod, ItemDye, ItemBed, 
//            ItemCookie, ItemMap, ItemShears, ItemRecord, 
//            ItemSpade, EnumToolMaterial, ItemPickaxe, ItemAxe, 
//            ItemSword, ItemHoe, ItemSeeds, Block, 
//            ItemDoor, Material, ItemBucket, ItemReed, 
//            StatList, ItemStack, EntityPlayer, World, 
//            EntityLiving, Entity
...
public class Item
{
    ...
    public static Item lighter = (new ItemFlintAndSteel(3)).setIconCoord(5, 0).setItemName("flintAndSteel");
    public static Item appleRed = (new ItemFood(4, 4, false, false, null)).setIconCoord(10, 0).setItemName("apple");
    ...
    public static Item bowlSoup = (new ItemSoup(26, 10, Item.bowlEmpty, 3001)).setIconCoord(8, 4).setItemName("mushroomStew");
    ...
    public static Item bread = (new ItemFood(41, 5, false, false, null)).setIconCoord(9, 2).setItemName("bread");
    ...
    public static Item porkRaw = (new ItemFood(63, 3, true, false, null)).setIconCoord(7, 5).setItemName("porkchopRaw");
    public static Item porkCooked = (new ItemFood(64, 8, true, false, null)).setIconCoord(8, 5).setItemName("porkchopCooked");
    public static Item painting = (new ItemPainting(65)).setIconCoord(10, 1).setItemName("painting");
    public static Item appleGold = (new ItemFood(66, 42, false, false, null)).setIconCoord(11, 0).setItemName("appleGold");
    ...
    public static Item fishRaw = (new ItemFood(93, 2, false, false, null)).setIconCoord(9, 5).setItemName("fishRaw");
    public static Item fishCooked = (new ItemFood(94, 5, false, false, null)).setIconCoord(10, 5).setItemName("fishCooked");
    ...
    public static Item cookie = (new ItemCookie(101, 1, false, false, null, 8)).setIconCoord(12, 5).setItemName("cookie");
    ...
    static 
    {
        shovelIron = (new ItemSpade(0, EnumToolMaterial.IRON)).setIconCoord(2, 5).setItemName("shovelIron");
        pickaxeIron = (new ItemPickaxe(1, EnumToolMaterial.IRON)).setIconCoord(2, 6).setItemName("pickaxeIron");
        axeIron = (new ItemAxe(2, EnumToolMaterial.IRON)).setIconCoord(2, 7).setItemName("hatchetIron");
        ...
        redstoneRepeater = (new ItemReed(100, Block.redstoneRepeaterOff)).setIconCoord(6, 5).setItemName("diode");

 ...
 */ 
    ...
    public static final Block blockOsmium = new BlockOreStorage(114, 176).setHardness(5F).setResistance(5F).setStepSound(Block.soundMetalFootstep).setBlockName("blockOsmium");
}

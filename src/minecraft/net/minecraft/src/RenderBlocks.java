...
//            Block, BlockRail, Config, Tessellator, 
//            IBlockAccess, BlockBed, ModelBed, BlockRedstoneRepeater, 
//            BlockPistonBase, BlockPistonExtension, Vec3D, BlockFire, 
//            BlockRedstoneWire, EntityRenderer, BlockFluid, MathHelper, 
//            Material, BlockDoor, World
...
public class RenderBlocks
{
    ...
    public boolean renderBlockByRenderType(Block block, int i, int j, int k)
    {
        ...
        {
            return Config.callBoolean("ModLoader", "RenderWorldBlock", new Object[] {
                this, blockAccess, Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), block, Integer.valueOf(l)
            });
        } else
        {
            return false;
    ...
    {
        enableAO = true;
        boolean flag = Config.getAmbientOcclusionLevel() > 0.0F;
        boolean flag1 = Config.isBetterGrass();
        boolean flag2 = false;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j - 1, k, 0))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                if(flag)
                {
                    field_22375_o = Config.fixAoLight(field_22375_o, aoLightValueYNeg);
                    field_22376_n = Config.fixAoLight(field_22376_n, aoLightValueYNeg);
                    field_22373_q = Config.fixAoLight(field_22373_q, aoLightValueYNeg);
                    field_22370_t = Config.fixAoLight(field_22370_t, aoLightValueYNeg);
                    field_22371_s = Config.fixAoLight(field_22371_s, aoLightValueYNeg);
                    field_22374_p = Config.fixAoLight(field_22374_p, aoLightValueYNeg);
                    field_22372_r = Config.fixAoLight(field_22372_r, aoLightValueYNeg);
                    field_22377_m = Config.fixAoLight(field_22377_m, aoLightValueYNeg);
                }
            ...
            colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag3 ? f : 1.0F) * 0.5F;
            colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag3 ? f1 : 1.0F) * 0.5F;
            colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag3 ? f2 : 1.0F) * 0.5F;
            colorRedTopLeft *= f7;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j + 1, k, 1))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                if(flag)
                {
                    field_22367_w = Config.fixAoLight(field_22367_w, aoLightValueYPos);
                    field_22368_v = Config.fixAoLight(field_22368_v, aoLightValueYPos);
                    field_22362_A = Config.fixAoLight(field_22362_A, aoLightValueYPos);
                    field_22360_B = Config.fixAoLight(field_22360_B, aoLightValueYPos);
                    field_22364_z = Config.fixAoLight(field_22364_z, aoLightValueYPos);
                    field_22366_x = Config.fixAoLight(field_22366_x, aoLightValueYPos);
                    field_22365_y = Config.fixAoLight(field_22365_y, aoLightValueYPos);
                    field_22369_u = Config.fixAoLight(field_22369_u, aoLightValueYPos);
                }
            ...
            colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = flag4 ? f : 1.0F;
            colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = flag4 ? f1 : 1.0F;
            colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = flag4 ? f2 : 1.0F;
            colorRedTopLeft *= f8;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k - 1, 2))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                if(flag)
                {
                    field_22358_C = Config.fixAoLight(field_22358_C, aoLightValueZNeg);
                    field_22369_u = Config.fixAoLight(field_22369_u, aoLightValueZNeg);
                    field_22366_x = Config.fixAoLight(field_22366_x, aoLightValueZNeg);
                    field_22356_D = Config.fixAoLight(field_22356_D, aoLightValueZNeg);
                    field_22365_y = Config.fixAoLight(field_22365_y, aoLightValueZNeg);
                    field_22374_p = Config.fixAoLight(field_22374_p, aoLightValueZNeg);
                    field_22372_r = Config.fixAoLight(field_22372_r, aoLightValueZNeg);
                    field_22377_m = Config.fixAoLight(field_22377_m, aoLightValueZNeg);
                }
            ...
            colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag5 ? f : 1.0F) * 0.8F;
            colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag5 ? f1 : 1.0F) * 0.8F;
            colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag5 ? f2 : 1.0F) * 0.8F;
            colorRedTopLeft *= f9;
            ...
            if(flag1)
            {
                if(l == 3)
                {
                    l = Config.getSideGrassTexture(blockAccess, i, j, k, 2);
                    if(l == 0)
                    {
                        colorRedTopLeft *= f;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k + 1, 3))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                if(flag)
                {
                    field_22354_E = Config.fixAoLight(field_22354_E, aoLightValueZPos);
                    field_22367_w = Config.fixAoLight(field_22367_w, aoLightValueZPos);
                    field_22362_A = Config.fixAoLight(field_22362_A, aoLightValueZPos);
                    field_22353_F = Config.fixAoLight(field_22353_F, aoLightValueZPos);
                    field_22360_B = Config.fixAoLight(field_22360_B, aoLightValueZPos);
                    field_22373_q = Config.fixAoLight(field_22373_q, aoLightValueZPos);
                    field_22370_t = Config.fixAoLight(field_22370_t, aoLightValueZPos);
                    field_22375_o = Config.fixAoLight(field_22375_o, aoLightValueZPos);
                }
            ...
            colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag6 ? f : 1.0F) * 0.8F;
            colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag6 ? f1 : 1.0F) * 0.8F;
            colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag6 ? f2 : 1.0F) * 0.8F;
            colorRedTopLeft *= f10;
            ...
            if(flag1)
            {
                if(i1 == 3)
                {
                    i1 = Config.getSideGrassTexture(blockAccess, i, j, k, 3);
                    if(i1 == 0)
                    {
                        colorRedTopLeft *= f;
                        colorRedBottomLeft *= f;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i - 1, j, k, 4))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                if(flag)
                {
                    field_22376_n = Config.fixAoLight(field_22376_n, aoLightValueXNeg);
                    field_22375_o = Config.fixAoLight(field_22375_o, aoLightValueXNeg);
                    field_22354_E = Config.fixAoLight(field_22354_E, aoLightValueXNeg);
                    field_22368_v = Config.fixAoLight(field_22368_v, aoLightValueXNeg);
                    field_22367_w = Config.fixAoLight(field_22367_w, aoLightValueXNeg);
                    field_22358_C = Config.fixAoLight(field_22358_C, aoLightValueXNeg);
                    field_22369_u = Config.fixAoLight(field_22369_u, aoLightValueXNeg);
                    field_22377_m = Config.fixAoLight(field_22377_m, aoLightValueXNeg);
                }
            ...
            colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag7 ? f : 1.0F) * 0.6F;
            colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag7 ? f1 : 1.0F) * 0.6F;
            colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag7 ? f2 : 1.0F) * 0.6F;
            colorRedTopLeft *= f11;
            ...
            if(flag1)
            {
                if(j1 == 3)
                {
                    j1 = Config.getSideGrassTexture(blockAccess, i, j, k, 4);
                    if(j1 == 0)
                    {
                        colorRedTopLeft *= f;
                        colorRedBottomLeft *= f;
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i + 1, j, k, 5))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                if(flag)
                {
                    field_22371_s = Config.fixAoLight(field_22371_s, aoLightValueXPos);
                    field_22370_t = Config.fixAoLight(field_22370_t, aoLightValueXPos);
                    field_22353_F = Config.fixAoLight(field_22353_F, aoLightValueXPos);
                    field_22364_z = Config.fixAoLight(field_22364_z, aoLightValueXPos);
                    field_22360_B = Config.fixAoLight(field_22360_B, aoLightValueXPos);
                    field_22356_D = Config.fixAoLight(field_22356_D, aoLightValueXPos);
                    field_22365_y = Config.fixAoLight(field_22365_y, aoLightValueXPos);
                    field_22372_r = Config.fixAoLight(field_22372_r, aoLightValueXPos);
                }
            ...
            colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag8 ? f : 1.0F) * 0.6F;
            colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag8 ? f1 : 1.0F) * 0.6F;
            colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag8 ? f2 : 1.0F) * 0.6F;
            colorRedTopLeft *= f12;
            ...
            if(flag1)
            {
                if(k1 == 3)
                {
                    k1 = Config.getSideGrassTexture(blockAccess, i, j, k, 5);
                    if(k1 == 0)
                    {
                        colorRedTopLeft *= f;
                        colorRedBottomLeft *= f;
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block block, int i, int j, int k, float f, float f1, float f2)
    {
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k + 1, 3))
        {
            ...
            renderWestFace(block, i, j, k, i1);
            if((fancyGrass || Config.isBetterGrass()) && i1 == 3 && overrideBlockTexture < 0)
            {
                tessellator.setColorOpaque_F(f11 * f23 * f, f14 * f23 * f1, f17 * f23 * f2);
                renderWestFace(block, i, j, k, 38);
            }
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i - 1, j, k, 4))
        {
            ...
            renderNorthFace(block, i, j, k, j1);
            if((fancyGrass || Config.isBetterGrass()) && j1 == 3 && overrideBlockTexture < 0)
            {
                tessellator.setColorOpaque_F(f12 * f24 * f, f15 * f24 * f1, f18 * f24 * f2);
                renderNorthFace(block, i, j, k, 38);
            }
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i + 1, j, k, 5))
        {
            ...
            renderSouthFace(block, i, j, k, k1);
            if((fancyGrass || Config.isBetterGrass()) && k1 == 3 && overrideBlockTexture < 0)
            {
                tessellator.setColorOpaque_F(f12 * f25 * f, f15 * f25 * f1, f18 * f25 * f2);
                renderSouthFace(block, i, j, k, 38);
            }
    ...
    public void renderBlockOnInventory(Block block, int i, float f)
    {
        ...
        if(Config.hasModLoader())
        {
            Config.callVoid("ModLoader", "RenderInvBlock", new Object[] {
                this, block, Integer.valueOf(i), Integer.valueOf(k)
            });
        }
    }
    ...
    public static boolean renderItemIn3d(int i)
    {
        ...
        if(Config.hasModLoader())
        {
            return Config.callBoolean("ModLoader", "RenderBlockIsItemFull3D", new Object[] {
                Integer.valueOf(i)
            });
        } else
        {

...
public class BlockRedstoneTorch extends BlockTorch
{
    ...
    public void updateTick(World world, int i, int j, int k, Random random)
    {
        ...
        if(torchActive)
        {
            if(flag)
            {
                world.setBlockAndMetadataWithNotify(i, j, k, Block.torchRedstoneOff.blockID, world.getBlockMetadata(i, j, k));
        ...
        {
            world.setBlockAndMetadataWithNotify(i, j, k, Block.torchRedstoneOn.blockID, world.getBlockMetadata(i, j, k));
        }
    }
    ...
    {
        return Block.torchRedstoneOn.blockID;
    }

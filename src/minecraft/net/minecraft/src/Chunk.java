...
public class Chunk
{
    ...
    public void onChunkUnload()
    {
		...
		Iterator iterator = chunkTileEntityMap.values().iterator(); iterator.hasNext(); tileentity.func_31005_i())
        {
    ...
    @SuppressWarnings("unchecked")
	public void getEntitiesWithinAABBForEntity(Entity entity, AxisAlignedBB axisalignedbb, @SuppressWarnings("rawtypes") List list)
    {
    ...
    @SuppressWarnings({ "unchecked" })
	public void getEntitiesOfTypeWithinAAAB(@SuppressWarnings("rawtypes") Class class1, AxisAlignedBB axisalignedbb, @SuppressWarnings("rawtypes") List list)
    {
        int i = MathHelper.floor_double((axisalignedbb.minY - 2D) / 16D);
        int j = MathHelper.floor_double((axisalignedbb.maxY + 2D) / 16D);
        if(i < 0)

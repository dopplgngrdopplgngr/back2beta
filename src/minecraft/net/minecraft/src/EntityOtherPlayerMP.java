...
//            EntityPlayer, World, MathHelper, ItemStack, 
//            InventoryPlayer, Entity
...
public class EntityOtherPlayerMP extends EntityPlayer
{
    ...
    public EntityOtherPlayerMP(World world, String s)
    {
        ...
        {
            skinUrl = (new StringBuilder()).append("http://skins.minecraft.net/MinecraftSkins/").append(s).append(".png").toString();
        }
        noClip = true;
        field_22062_y = 0.25F;

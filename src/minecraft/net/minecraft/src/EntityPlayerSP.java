...
//            MovementInput, AchievementList, StatFileWriter, GuiAchievement, 
...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public EntityPlayerSP(Minecraft minecraft, World world, Session session, int i)
    {
        ...
        {
            skinUrl = (new StringBuilder()).append("http://skins.minecraft.net/MinecraftSkins/").append(session.username).append(".png").toString();
        }
    ...
    public void onLivingUpdate()
    {
		...
		pushOutOfBlocks(posX - (double) width * 0.34999999999999998D, boundingBox.minY + 0.5D,
				posZ + (double) width * 0.34999999999999998D);
		pushOutOfBlocks(posX - (double) width * 0.34999999999999998D, boundingBox.minY + 0.5D,
				posZ - (double) width * 0.34999999999999998D);
    ...
    public void onDeath(Damage damage)
    {
     if(!worldObj.multiplayerWorld)
     {
     GuiGameOver.deathReason = new StringBuilder().append(username).append(damage.deathReason).toString();
     }

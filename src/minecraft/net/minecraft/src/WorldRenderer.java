...
//            MathHelper, AxisAlignedBB, RenderItem, Config, 
//            Chunk, ChunkCache, RenderBlocks, Tessellator, 
...
public class WorldRenderer
{
    ...
    public void updateRenderer()
    {
        ...
        Object obj = Config.getFieldValue("LightCache", "cache");
        if(obj != null)
        {
            Config.callVoid(obj, "clear", new Object[0]);
    ...
    public void updateInFrustrum(ICamera icamera)
    {
        ...
        {
            isInFrustrumFully = icamera.isBoundingBoxInFrustumFully(rendererBoundingBox);
        } else
        {
            isInFrustrumFully = false;
        }

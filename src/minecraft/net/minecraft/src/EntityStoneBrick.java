...
public class EntityStoneBrick extends EntityThrowing
{

    public EntityStoneBrick(World world, EntityLiving entityliving)
    {
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            ...
            {
                if(!movingobjectposition.entityHit.attackEntityFrom(Damage.mobIndirect(thrower, this), 5));
            }
            for(int j = 0; j < 8; j++)
            {
                worldObj.spawnParticle("stonebrickpoof", posX, posY, posZ, 0.0D, 0.0D, 0.0D);
            }
            setEntityDead();
        }
    ...
    public EntityStoneBrick(World world)
    {
    	super(world);
    }
    
    public EntityStoneBrick(World world, double d, double d1, double d2)
    {
        super(world, d, d1, d2);
    }

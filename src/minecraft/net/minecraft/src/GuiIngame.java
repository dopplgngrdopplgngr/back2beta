...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float f, boolean flag, int i, int j)
    {
        ...
        fontrenderer.drawStringWithShadow((new StringBuilder()).append(B2B.version).toString(), 2, 2, 0xffffff);
        ...
        if(mc.gameSettings.showDebugInfo)
        {
            ...
            fontrenderer.drawStringWithShadow((new StringBuilder()).append((new StringBuilder()).append(B2B.version).append(" (Back 2 Beta Edition)").toString()).toString(), 2, 2, 0xffffff);
            fontrenderer.drawStringWithShadow((new StringBuilder()).append("(").append(mc.debug).append(")").toString(), 2, 12, 0xffffff);
            fontrenderer.drawStringWithShadow(mc.func_6241_m(), 2, 22, 0xffffff);
            fontrenderer.drawStringWithShadow(mc.func_6262_n(), 2, 32, 0xffffff);
            fontrenderer.drawStringWithShadow(mc.func_6245_o(), 2, 42, 0xffffff);
            fontrenderer.drawStringWithShadow(mc.func_21002_o(), 2, 52, 0xffffff);
            ...
            drawString(fontrenderer, (new StringBuilder()).append("f: ").append(MathHelper.floor_double((double)((mc.thePlayer.rotationYaw * 4F) / 360F) + 0.5D) & 3).toString(), 2, 88, 0xe0e0e0);
             ...
             drawString(fontrenderer, new StringBuilder().append("Seed: ").append(mc.theWorld.getRandomSeed()).toString(), 2, 98, 0xe0e0e0);
            GL11.glPopMatrix();
        }

...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    public void wakeUpPlayer(boolean flag, boolean flag1, boolean flag2)
    {
        ...
        if(chunkcoordinates != null && worldObj.getBlockId(chunkcoordinates.x, chunkcoordinates.y, chunkcoordinates.z) == Block.bed.blockID)
        {
    ...
    {
        return worldObj.getBlockId(bedChunkCoordinates.x, bedChunkCoordinates.y, bedChunkCoordinates.z) == Block.bed.blockID;
    }

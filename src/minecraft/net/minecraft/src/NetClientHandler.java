...
//            Block, EntityLiving, Packet71Weather, EntityLightningBolt, 
...
//            Packet61DoorChange, EntityClientPlayerMP, Packet200Statistic, Packet, 
...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn packet23vehiclespawn)
    {
        ...
        {
        	obj = new EntityStoneBrick(worldClient, d, d1, d2);
        }
    ...
    {
    	if(packet3chat.message.startsWith(mc.session.username))
    	{
    	 GuiGameOver.deathReason = packet3chat.message;
    	}
    ...
    {
        Explosion explosion = new Explosion(mc.theWorld, Damage.explodeGeneric, packet60explosion.explosionX, packet60explosion.explosionY, packet60explosion.explosionZ, packet60explosion.explosionSize);
    ...
    {
        mc.theWorld.playAuxSFXnull(packet61doorchange.field_28050_a, packet61doorchange.field_28053_c, packet61doorchange.field_28052_d, packet61doorchange.field_28051_e, packet61doorchange.field_28049_b);
    }

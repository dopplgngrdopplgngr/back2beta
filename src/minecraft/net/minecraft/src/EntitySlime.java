    ...
    implements IMob
{
    ...
    {
        int i = getSlimeSize();
        if(i > 1 && canEntityBeSeen(entityplayer) && (double)getDistanceToEntity(entityplayer) < 0.59999999999999998D * (double)i && entityplayer.attackEntityFrom(Damage.mob(this), i))
        {

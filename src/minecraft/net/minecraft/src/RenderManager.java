...
//            EntityLightningBolt, RenderLightningBolt, EntityStoneBrick, Render, 
...
public class RenderManager
{
    ...
    private RenderManager()
    {
        ...
        entityRenderMap.put(net.minecraft.src.EntityStoneBrick.class, new RenderSnowball(B2BItems.stoneBrick.getIconFromDamage(0)));
        Render render;

...
public class Damage {
    ...
    public static DamageMob mob(Entity entity)
    {
      ...
      {
    	if(((EntityWolf)entity).isWolfTamed() && ((EntityWolf)entity).getWolfOwner() != null)
    	{
    	  mobComplex = new StringBuilder().append(" was killed by ").append(((EntityWolf)entity).getWolfOwner()).append("'s Wolf").toString();
    	} else

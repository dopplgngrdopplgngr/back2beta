    ...
    implements IChunkProvider
{
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        for(int i4 = 0; i4 < 1; i4++)
        {
            ...
            (new WorldGenMinable(Block.oreDiamond.blockID, 15)).generate(worldObj, rand, j7, k10, j13);
        }
        ...
        for(int rare = 0; rare < 12; rare++)
        {
            int xRand = k + rand.nextInt(16);
            int yRand = rand.nextInt(72);
            int zRand = l + rand.nextInt(16);
            (new WorldGenMinable(B2BBlocks.oreCopper.blockID, 6)).generate(worldObj, rand, xRand, yRand, zRand);
        }
        ...
        if(rand.nextInt(2) == 0)
        {
            ...
            (new WorldGenFlowers(Block.flowerRose.blockID)).generate(worldObj, rand, j15, j17, j20);
        }
        if(rand.nextInt(4) == 0)
        {

...
public class GuiGameOver extends GuiScreen
{
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        GL11.glPopMatrix();
        drawCenteredString(fontRenderer, (new StringBuilder()).append("Score: \247e").append(mc.thePlayer.getScore()).toString(), width / 2, 100, 0xffffff);
        drawCenteredString(fontRenderer, (deathReason), width / 2, 85, 0xffffff);

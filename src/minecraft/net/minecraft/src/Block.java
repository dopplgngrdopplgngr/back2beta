...
public class Block
{
	...
	public void getCollidingBoundingBoxes(World world, int i, int j, int k, AxisAlignedBB axisalignedbb, @SuppressWarnings("rawtypes") ArrayList arraylist)
    {
    ...
    public static final BlockFlower flowerYellow;
    public static final BlockFlower flowerRose;
    ...
    public static final Block furnaceOff;
    public static final Block furnaceOn;
    ...
    public static final Block torchRedstoneOff;
    public static final Block torchRedstoneOn;
    ...
    static 
    {
        ...
        cobblestone = (new Block(4, 16, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("cobblestone");
        planks = (new BlockPlanks(5, 4)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("wood").disableNeighborNotifyOnMetadataChange();
        ...
        flowerYellow = (BlockFlower)(new BlockFlower(37, 13)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("flower");
        flowerRose = (BlockFlower)(new BlockFlower(38, 12)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("rose");
        ...
        blockIron = (new BlockOreStorage(42, 22)).setHardness(5F).setResistance(10F).setStepSound(soundMetalFootstep).setBlockName("blockIron");
        ...
        obsidian = (new BlockObsidian(49, 37)).setHardness(30F).setResistance(2000F).setStepSound(soundStoneFootstep).setBlockName("obsidian");
        ...
        furnaceOff = (new BlockFurnace(61, false)).setHardness(3.5F).setStepSound(soundStoneFootstep).setBlockName("furnace").disableNeighborNotifyOnMetadataChange();
        furnaceOn = (new BlockFurnace(62, true)).setHardness(3.5F).setStepSound(soundStoneFootstep).setLightValue(0.875F).setBlockName("furnace").disableNeighborNotifyOnMetadataChange();
        ...
        torchRedstoneOff = (new BlockRedstoneTorch(75, 115, false)).setHardness(0.0F).setStepSound(soundWoodFootstep).setBlockName("notGate").disableNeighborNotifyOnMetadataChange();
        torchRedstoneOn = (new BlockRedstoneTorch(76, 99, true)).setHardness(0.0F).setLightValue(0.5F).setStepSound(soundWoodFootstep).setBlockName("notGate").disableNeighborNotifyOnMetadataChange();
        ...
        redstoneRepeaterOff = (new BlockRedstoneRepeater(93, false)).setHardness(0.0F).setStepSound(soundWoodFootstep).setBlockName("diode").disableStats().disableNeighborNotifyOnMetadataChange();
        redstoneRepeaterOn = (new BlockRedstoneRepeater(94, true)).setHardness(0.0F).setLightValue(0.625F).setStepSound(soundWoodFootstep).setBlockName("diode").disableStats().disableNeighborNotifyOnMetadataChange();
        ...
        Item.itemsList[B2BBlocks.decPlanks.blockID] = (new ItemDecPlanks(B2BBlocks.decPlanks.blockID - 256)).setItemName("decWood");
